...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<div class="user-photo">
			...
			<p>你好!${sessionScope.username},欢迎登录</p>
		</div>
		<!-- 左侧菜单 -->
		<ul class="layui-nav layui-nav-tree">
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                    ...
                    <dd>
                        <a href="javascript:;" data-url="blindMail.jsp">
                            <i class="iconfont icon-piliangicon" data-icon='icon-piliangicon'></i>
                            <span>邮箱绑定</span>
                        </a>
                    </dd>
					<dd>
						<a href="javascript:;" data-url="ShowBind.jsp">
			...
			<li class="layui-nav-item">
					<a href="javascript:;">
					   ...
					   <dl class="layui-nav-child">
					   	   <dd>
					    		<a href="javascript:;" data-url="sendMail.jsp">
					    		   <i class="iconfont icon-lanmuguanli" data-icon='icon-lanmuguanli'></i>
					    		   <span>发送邮件</span>
					    		</a>
					    	</dd>
					    	<dd>
					    		<a href="javascript:;" data-url="mailbox.jsp">
